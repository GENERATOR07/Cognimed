  ...
  return (
    <div className="bg-blue-950 w-[70px] flex flex-col justify-between pb-8 items-center">
     ...
     <div className='flex flex-col items-center gap-2 '>
        ...
        <button onClick={toggleMode} className=' flex flex-col bg-white rounded-2xl p-2 gap-2 w-8 items-center'>

         <div className={`bg-gray-900 w-5 h-5 rounded-full ${userMode ? 'opacity-0' : 'opacity-100'} transition-all  duration-500`} ></div>
         <div className={`bg-blue-700 w-5 h-5 rounded-full ${userMode ? 'opacity-100' : 'opacity-0'} transition-all  duration-500`} ></div>
        </button>
